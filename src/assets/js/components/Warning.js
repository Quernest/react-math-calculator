        ...
        return (
            <div id="warning">
                ...
                <div id="warning-content">
                    ...
                    <h4>Например:</h4><p>Функция f(x) = x*x + 2*x на интервале [-3, 5]</p>
                </div>
            </div>
        );
    }
